...
export const CotizacionPDF = ({ data }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>ComputerCity - Tu tienda de tecnología</Text>
          <Text style={styles.footerText}>Esta cotización tiene validez por 30 días</Text>
        </View>
